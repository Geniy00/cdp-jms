...
<h3>
    ...
    --
    <a href="filtered?status=REVOKED" style="color: #00008b; text-decoration: none; background-color: #dbffaa">Revoked</a>
    --
...
<c:forEach var="booking" items="${bookings}">
    ...
    <c:if test="${booking.status == 'NEW' || booking.status == 'REVOKED' || booking.status == 'ASSIGNED'}">
    ...
    <div style='background-color: ${color}; border: solid 1px black; display:inline-block; margin: 8px;'>
        <table>
            ...
            <tr>
                <td></td>
                <td>Delivery time:
                    <joda:format value="${booking.bookingRequest.deliveryTime}" pattern="HH:mm, dd MMM"/></td>
                <td>
